...
public class Eqrental {
	...
	public String toString() {
		return "Eqrental [eq_lease_id=" + eq_lease_id + ", eq_id=" + eq_id + ", eq_count=" + eq_count + ", eq_charge="
				+ eq_charge + ", eq_date_rental=" + eq_date_rental + ", eq_date_return=" + eq_date_return
				+ ", eq_isreturn=" + eq_isreturn + ", eq_user_id=" + eq_user_id + ", eq_staff_id=" + eq_staff_id + "]";
	}
