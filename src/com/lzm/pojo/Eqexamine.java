...
public class Eqexamine {
	...
	public String toString() {
		return "Eqexamine [eq_ex_id=" + eq_ex_id + ", eq_id=" + eq_id + ", eq_staff_id=" + eq_staff_id + ", eq_overdue="
				+ eq_overdue + ", eq_num_damage=" + eq_num_damage + ", eq_num_lose=" + eq_num_lose + ", eq_publish="
				+ eq_publish + "]";
	}
