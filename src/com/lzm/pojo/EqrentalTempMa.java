...
public class EqrentalTempMa {
	...
	public String toString() {
		return "EqrentalTempMa [eq_lease_id=" + eq_lease_id + ", eq_name="
				+ eq_name + ", eq_count=" + eq_count + ", eq_date_return="
				+ eq_date_return + ", eq_date_rental=" + eq_date_rental
				+ ", eq_user_id=" + eq_user_id + "]";
	}
