...
public class SSGL_controller {
	...
	public String SSXG_chauxn(String shenqingren, Model model) {
		...
		// System.out.println(s.getShenqingren() + "," + s.getChangdi() + "," +
		//// s.getKaishishijian() + ","
		// + s.getJieshushijian() + "," + s.getZhifubiaoji() + "," +
		//// s.getDingdanjine() + "," + s.getQicai()+ "," +
		//// s.getShenqingriqi());
	...
	public String SSXG_1(lth_SSGL XX, Model model) {
		...
		// System.out.println(XX.getShenqingren() + "," + XX.getChangdi() + ","
		// + XX.getKaishishijian() + ","
		// + XX.getJieshushijian() + "," + XX.getQicai() + "," +
		// XX.getShenqingriqi());
		aService.SSSQ_1(XX);
	...
	public String DDZF(lth_SSGL DD, Model model) {
		System.out.println(
				DD.getShenqingren() + "," + DD.getCDmoney() + "," + DD.getQCmoney() + "," + DD.getDingdanjine());
		aService.zhifu(DD);
	...
	//
	// public @ResponseBody String updEmployee(AdsvEmployee employee,
