			...
			<div class="row clearfix">
				<div class="col-md-6 column">
					<span class="span-select">
						...
						onclick="window.location.href='${pageContext.request.contextPath }/query.action'">
				...
				<div class="col-md-6 column">
					<span class="span-select">
						<button type="button" class="btn btn-success btn-user"
						 onclick="window.location.href='${pageContext.request.contextPath }/jiazai_1.action'">
							<p class="p-fontsize">赛事申请</p>
						</button>
					</span>
				</div>
			</div>
			<div class="row clearfix">
				<div class="col-md-6 column">
					<span class="span-select">
						...
						onclick="window.location.href='${pageContext.request.contextPath }/cz_query.action'">
							<p class="p-fontsize">赛事修改</p>
						</button>
					</span>
				</div>
				<div class="col-md-6 column">
					<span class="span-select">
						<button type="button" id="query" class="btn btn-warning btn-user" 
						onclick="window.location.href='${pageContext.request.contextPath }/YH_query.action'">
							<p class="p-fontsize">订单支付</p>
						</button>
					</span>
				</div>
			</div>
