			    ...
			    <div class="layui-side-scroll">
			      ...
			      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
			        ...
			        <li class="layui-nav-item"><a href="#" >管理员用户</a></li>
			        	<li class="layui-nav-item"><a href="${pageContext.request.contextPath }/html/ltc_superManage/query_manage_role.jsp"   class="layui-this" >&nbsp;&nbsp;->管理员用户查询</a></li>
            ...
            <div class="layui-field-box">
              ...
              <div class="layui-btn-group">
                  <button class="layui-btn layui-btn-sm layui-btn-primary dw-dailog" 
                  		onclick="window.location.href='${pageContext.request.contextPath }/html/ltc_superManage/add_manage_role.jsp'">
                      <i class="layui-icon">&#xe654;</i>新增
                  </button>
                  <button class="layui-btn layui-btn-sm layui-btn-primary dw-refresh"
                  		onclick="window.location.href='${pageContext.request.contextPath }/ltc_manage_query2.action'">
		                  ...
		                  <c:forEach var="user" items="${manageUserList }">
		                        ...
		                        <td class="text-center">
			                        <div class="layui-btn-group">
			                          ...
			                          onclick="window.location.href='${pageContext.request.contextPath }/ltc_manage_queryByID.action?controllerID=${user.controllerID }'">
			                            <i class="layui-icon">&#xe642;</i>编辑
			                          </button>
			                          <button class="layui-btn layui-btn-xs layui-btn-primary dw-delete" 
			                          onclick="window.location.href='${pageContext.request.contextPath }/ltc_manage_delete.action?controllerID=${user.controllerID }'">
