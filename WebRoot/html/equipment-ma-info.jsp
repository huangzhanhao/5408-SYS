	...
	<div class="layui-layout layui-layout-admin"> 
	    ...
	    <div class="layui-layout-body" style="padding: 15px;">
	        <fieldset class="layui-elem-field">
	            ...
	            <c:if test="${eqq!=null }">
	            	<legend>请修改</legend>
	            	<form class="form-horizontal" id="forminfo" action="${pageContext.request.contextPath }/updateEq.action" method="post" role="form">
						<div class="form-group">
							 <label for="inputPassword6" class="col-sm-2 control-label">器材编号</label>
							<div class="col-sm-1">
								<input type="text"  readonly = "readonly" name="eqId" class="form-control" id="inputPassword6" value="${eqq.eqId }"/>
							</div>
						</div>
						<div class="form-group">
						    <label class="col-sm-2 control-label">器材名称</label>
							<div class="col-sm-2">
								<input class="form-control" type="text" name="eqName" id="eq_name" value="${eqq.eqName }">
							</div>
						</div>
						<div class="form-group">
