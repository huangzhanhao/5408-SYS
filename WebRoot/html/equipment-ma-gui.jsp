	...
	<div class="layui-layout layui-layout-admin"> 
	    ...
	    <div class="layui-layout-body" style="padding: 15px;">
	        ...
	        <H3>${msg}</H3>
	            ...
	            <c:if test="${eqrr!=null }">
	            	<legend>请审核</legend>
	            	<form class="form-horizontal" action="${pageContext.request.contextPath }/addEqexamine.action" method="post" role="form">
						<div class="form-group">
							 <label for="inputPassword6" class="col-sm-2 control-label">归还单号</label>
							<div class="col-sm-3">
								<input type="text"  readonly = "readonly" name="eq_ex_id" class="form-control" id="inputPassword6" value="${eqrr.eq_return_id }"/>
							</div>
						</div>
						<div class="form-group">
						    <label class="col-sm-2 control-label">器材id</label>
							<div class="col-sm-2">
								<input class="form-control"  readonly="readonly" type="text" name="eq_id" id="eq_id" value="${eqrr.eq_id }">
								<input type="hidden" name="eq_staff_id"  value="<%=(String) session.getAttribute("username")%>">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="form-group">
									...
									<input type="text" readonly="readonly" class="form-control" name="eq_num_damage" value="0" data-max="10" data-min="0" data-step="1"> 
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="form-group">
									<div class="input-group col-sm-10 spinner" style="width: 100px;padding-left:15px;" data-trigger="spinner" id="spinner"> 
									<input type="text" readonly="readonly" class="form-control" name="eq_num_lose" value="0" data-max="10" data-min="0" data-step="1"> 
									<div class="input-group-addon"> 
									<a href="javascript:;" class="spin-up" id="lose-up">+</a> 
									<a href="javascript:;" class="spin-down" id="lose-down">-</a> 
									</div> 
									</div>
								</div>
							</div>
