...
<div class="container">
	...
	<c:if test="${lists!=null }">
		<div class="col-md-12 column">
			...
			<ul class="nav nav-tabs">
				<li class="active" >
					 <a href="#" id="detail-tag-a">未归还的器材</a>
				</li>
			</ul>
				...
				<tbody>
					<c:forEach items="${eqreturns }" var="item">
						<tr>
							...
							<td>
							<c:if test="${item.eq_exam_state=='已审核' }">
		...
		<div class="col-md-8 column div-block" style="margin-top:35px;">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text"  readonly = "readonly"  class="form-control"  value="${eqexam.eq_ex_id }"/>
					</div>
				</div>
				<div class="form-group" style="padding-top:30px">
					 <label  class="col-sm-2 control-label">器材编号</label>
					<div class="col-sm-10">
						<input type="text"  readonly = "readonly"  class="form-control"  value="${eqexam.eq_id }"/>
					</div>
				</div>
				<div class="form-group" style="padding-top:30px">
				    <label class="col-sm-2 control-label">审核人员编号</label>
					<div class="col-sm-10">
						<input class="form-control" readonly = "readonly" type="text" value="${eqexam.eq_staff_id }" >
					</div>
				</div>
				...
				<div class="form-group" style="padding-top:30px">
					...
					<div class="col-sm-10">
						<input class="form-control" readonly = "readonly" type="text" value="${eqexam.eq_overdue }" >
					</div>
				</div>
				<div class="form-group" style="padding-top:30px">
				    <label class="col-sm-2 control-label">损坏数量</label>
					<div class="col-sm-10" > 
						<input type="text" readonly = "readonly" class="form-control"  value="${eqexam.eq_num_damage }" > 
					</div>
				</div>
				<div class="form-group" style="padding-top:30px">
					 <label class="col-sm-2 control-label">丢失数量</label>
					<div class="col-sm-10">
						<input type="text" readonly = "readonly" class="form-control"  value="${eqexam.eq_num_lose }" />
					</div>
				</div>
				<div class="form-group" style="padding-top:30px">
					 <label class="col-sm-2 control-label">需扣除罚金</label>
					<div class="col-sm-10">
						<input type="text" readonly = "readonly"  class="form-control" value="${eqexam.eq_publish }" />
					</div>
				</div>
				<div class="form-group" style="padding-top:30px">
					<div class="col-sm-10">
