		...
		<div class="layui-body" id="mainBody">
			...
			<div class="layui-layout-body" style="padding: 15px;">
				<fieldset class="layui-elem-field">
					...
					<c:if test="${eqs!=null }">
						<legend>请修改</legend>
						<form id="chargeform" class="form-horizontal"
							action="${pageContext.request.contextPath }/updateEqSpend.action"
							method="post" role="form">
							<div class="form-group">
								<label for="inputPassword6" class="col-sm-2 control-label">器材编号</label>
								<div class="col-sm-1">
									<input type="text" readonly="readonly" name="eq_id"
										class="form-control" id="inputPassword6" value="${eqs.eq_id }" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input class="form-control" readonly="readonly" type="text"
										name="eq_name" value="${eqs.eq_name }">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input class="form-control" type="text" name="eq_overdue"
										value="${eqs.eq_overdue }">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label">损坏赔偿</label>
								<div class="col-sm-2">
									<input class="form-control" type="text" name="eq_damage"
										value="${eqs.eq_damage }">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input class="form-control" type="text" name="eq_lose"
										value="${eqs.eq_lose }">
								</div>
							</div>
