				...
				<fieldset class="layui-elem-field">
					...
					<c:if test="${eqw!=null }">
						<form id="form-new" class="form-horizontal"
							action="${pageContext.request.contextPath }/addEqWare.action"
							method="post" role="form">
							<div class="form-group">
								<label class="col-sm-2 control-label">仓库名称</label>
								<div class="col-sm-2">
									<input class="form-control" type="text"
										name="eq_warehouse_name" value="${eqww.eq_warehouse_name }">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input class="form-control" type="text"
										name="eq_warehouse_address"
										value="${eqww.eq_warehouse_address }">
								</div>
							</div>
							<div class="form-group">
					...
					<c:if test="${eqww!=null }">
						<legend>请修改</legend>
						<form id="form-xiugai" class="form-horizontal"
							action="${pageContext.request.contextPath }/updateEqWare.action"
							method="post" role="form">
							<div class="form-group">
								<label for="inputPassword6" class="col-sm-2 control-label">仓库编号</label>
								<div class="col-sm-1">
									<input type="text" readonly="readonly" class="form-control"
										id="inputPassword6" name="eq_warehouse_id"
										value="${eqww.eq_warehouse_id }" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label">仓库名称</label>
