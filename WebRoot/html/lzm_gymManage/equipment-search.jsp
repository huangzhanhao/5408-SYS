	...
	<div class="container">
		...
		<div class="row clearfix div-block">
			<div class="col-md-12 column">
				<form action="${pageContext.request.contextPath }/toSearch.action"
					...
					<div class="form-group text-search-div">
						<input type="text" name="str" class="form-control"
							style="height: 100%" size="75" placeholder="请输入需要器材信息" />
					</div>
		...
		<c:if test="${eqList==null }">
			<div class="col-md-12 column" id="welcome-div"
		...
		<c:if test="${eqList!=null }">
			<div class="col-md-12 column" id="detail-div">
				<ul class="nav nav-tabs">
					<li class="active"><a href="#" id="detail-tag-a">查询结果</a></li>
				</ul>
				<table class="table">
					<thead>
						<tr>
