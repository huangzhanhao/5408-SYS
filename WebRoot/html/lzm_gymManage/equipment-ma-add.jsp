		...
		<div class="layui-body" id="mainBody">
			...
			<div class="layui-layout-body" style="padding: 15px;">
				...
				<form id="form-add" class="form-horizontal"
					action="${pageContext.request.contextPath }/addNewEq.action"
					method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<div class="input-group col-sm-10 spinner" style="width: 100px;"
								data-trigger="spinner" id="spinner">
								<input type="text" class="form-control" name="eqAmount"
									id="count" value="1" data-max="100" data-min="1" data-step="1">
					...
					<div class="form-group">
						...
						<div class="input-group col-sm-10 "
							style="width: 135px; padding-left: 15px;" data-trigger="spinner"
							id="spinner">
					...
					<div class="form-group">
						...
						<div class="input-group col-sm-10 "
							style="width: 135px; padding-left: 15px;" data-trigger="spinner"
							id="spinner">
							<input class="form-control" type="text" name="eq_deposit"
								value="">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="input-group col-sm-10 "
							style="width: 135px; padding-left: 15px;" data-trigger="spinner"
							id="spinner">
							<input class="form-control" type="text" name="eq_overdue"
								value="">
						</div>
					</div>
					<div class="form-group">
									...
									<c:forEach items="${eqList }" var="list">
										<tr>
											<td><input type="text" class="form-control"
												readonly="readonly" style="width: 50px" name="eq_id"
												value="${list.eqId }"></td>
											<td>${list.eqName }</td>
											<td>${list.eqAmount }</td>
											<td>
												<div class="form-group">
													<div class="input-group col-sm-10 spinner"
														...
														data-trigger="spinner" id="spinner">
														<input type="text" class="form-control" name="eq_count"
															id="count" value="1" data-max="${list.eqSurplus }"
