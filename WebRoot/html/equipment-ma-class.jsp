	...
	<div class="layui-layout layui-layout-admin"> 
	    ...
	    <div class="layui-layout-body" style="padding: 15px;">
	        ...
	        <legend>添加分类</legend>
	        	...
	        	<c:if test="${eqc!=null }">
	        	<form id="form-new" class="form-horizontal" action="${pageContext.request.contextPath }/addEqClass.action" method="post" role="form">
	            ...
	            <c:if test="${eqcc!=null }">
	            	<legend>请修改</legend>
	            	<form id="form-old" class="form-horizontal" action="${pageContext.request.contextPath }/updateEqClass.action" method="post" role="form">
						<div class="form-group">
							 <label for="inputPassword6" class="col-sm-2 control-label">分类编号</label>
							<div class="col-sm-1">
								<input type="text"  readonly = "readonly" class="form-control" id="inputPassword6" name="eqClassId" value="${eqcc.eqClassId }"/>
							</div>
						</div>
						<div class="form-group">
						    <label class="col-sm-2 control-label">分类名称</label>
							<div class="col-sm-2">
								<input class="form-control"  type="text" name="eqClassName"  value="${eqcc.eqClassName }">
							</div>
						</div>
